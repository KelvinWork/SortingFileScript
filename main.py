...
folderLocation ="/Users/butac/Desktop/Mosquitto/"

for y in range(5):

    imageMondaySourceLocation = "/Users/butac/Desktop/EW41/" + date[y][0:] + "/"



    testingLocation1 = folderLocation[0:] + date[y][0:] + "AEG"
    testingLocation2 = folderLocation[0:] + date[y][0:] + "ALB"
    testingLocation3 = folderLocation[0:] + date[y][0:] + "Aesp"
    testingLocation4 = folderLocation[0:] + date[y][0:] + "Chiro"
    testingLocation5 = folderLocation[0:] + date[y][0:] + "Oi"
    testingLocation6 = folderLocation[0:] + date[y][0:] + "5fas"
